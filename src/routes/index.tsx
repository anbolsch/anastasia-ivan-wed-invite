      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-8 lg:px-12 py-6">
        <div className="border border-deep/40 px-4 sm:px-8 lg:px-14 py-8 sm:py-12">
          ...
          <section id="place" className="mt-24">
            ...
            <a
              href="https://yandex.com/maps/-/CTQwjQ3q"
              target="_blank"
              rel="noreferrer"
              className="mt-10 block border border-deep/30 p-2 bg-cream shadow-lg"
            >
              <iframe
                ...
                className="w-full h-[420px] block border-0 pointer-events-none"
                loading="lazy"
              />
            </a>
